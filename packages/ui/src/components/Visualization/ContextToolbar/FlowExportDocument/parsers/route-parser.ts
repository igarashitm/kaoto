...
import { HeadingLevel, ParsedTable } from './parsed-model';
...
export class RouteParser {
  ...
  static parseErrorHandlerEntity(entity: CamelErrorHandlerVisualEntity): ParsedTable | undefined {
    return RouteParser.doParseErrorHandler(entity.errorHandlerDef, 'h1');
  }

  private static doParseErrorHandler(errorHandler: ErrorHandler, level: HeadingLevel): ParsedTable | undefined {
  ...
  static parseInterceptFromEntity(entity: CamelInterceptFromVisualEntity): ParsedTable | undefined {
    return RouteParser.doParseInterceptFrom(entity.interceptFromDef.interceptFrom, 'h1');
  }
  ...
  static parseOnCompletionEntity(entity: CamelOnCompletionVisualEntity): ParsedTable | undefined {
    return RouteParser.doParseOnCompletion(entity.onCompletionDef.onCompletion, 'h1');
  }
  ...
  static parseOnExceptionEntity(entity: CamelOnExceptionVisualEntity): ParsedTable | undefined {
    return RouteParser.doParseOnException(entity.onExceptionDef.onException, 'h1');
  }
